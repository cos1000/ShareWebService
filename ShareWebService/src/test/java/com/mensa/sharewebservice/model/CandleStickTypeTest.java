 ...
 * @author matt_
 */
public class CandleStickTypeTest extends TestCase {
	...
	protected void setUp() throws Exception {
        ...
        {
            System.out.println("Start CandleStickType Test finalize"); 
...
//            session.close();
	...
	protected void tearDown() throws Exception {
            System.out.println("Start CandleStickType Test tearDown"); 
            entityManagerFactory.close();
	}
        
        public CandleStickType createRecord() {
            System.out.println("start createTrading"); 
            CandleStickType share = new CandleStickType();
        ...
        public CandleStickType getTestingRecord() {
            System.out.println("start getTestingRecord"); 
            List<CandleStickType> answer = entityManager.createQuery( "select record from CandleStickType record", CandleStickType.class)
                    .setMaxResults(1)
                    .getResultList(); 
	...
	public void testCreateRecord() {
            ...
            CandleStickType share = getTestingRecord(); 
            setRollback(); 
