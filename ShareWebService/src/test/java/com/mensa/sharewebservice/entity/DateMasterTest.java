 ...
 * @author matt_
 */
public class DateMasterTest extends TestCase {
	...
	protected void setUp() throws Exception {
        ...
        {
            System.out.println("Start DateMaster Test finalize"); 
...
//            session.close();
	...
	protected void tearDown() throws Exception {
            System.out.println("Start DateMaster Test tearDown"); 
            entityManagerFactory.close();
	}
        
        public DateMaster createRecord() {
            System.out.println("start createTrading"); 
            DateMaster share = new DateMaster();
            
            share.setDate_code(LocalDateTime.now()); 
        ...
        public DateMaster getTestingRecord() {
            System.out.println("start getTestingRecord"); 
            List<DateMaster> answer = entityManager.createQuery( "select record from DateMaster record", DateMaster.class)
                    .setMaxResults(1)
                    .getResultList(); 
	...
	public void testCreateRecord() {
            ...
            DateMaster share = getTestingRecord(); 
            setRollback(); 
